...
Here is an example of the colorectal cancer cell lines with *KRAS* mutations in the hotspot codons, only showing edges for scores less than -1. If there were multiple scores for a target-*RAS* allele, the median value was used. The color and edge width correlate with the CERES score.
